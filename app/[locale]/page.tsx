    ...
    <>
      <section className="vs-gradient text-white py-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href={`/${locale}/contact`} className="px-8 py-4 bg-white text-[#0F6FC6] font-bold rounded-lg hover:bg-white/90 transition-colors text-sm uppercase tracking-wide">
              {d.heroCTAPrimary}
            </Link>
            <Link href={`/${locale}/diensten`} className="px-8 py-4 border-2 border-white/50 text-white font-bold rounded-lg hover:border-white hover:bg-white/10 transition-colors text-sm uppercase tracking-wide">
              {d.heroCTASecondary}
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {['Zorg', 'Zakelijke Dienstverlening', 'Real Estate'].map((sector, i) => (
              <Link key={i} href={`/${locale}/sectoren`} className="p-8 rounded-xl vs-gradient text-white hover:opacity-95 transition-opacity">
      ...
      <section className="py-24 px-6 bg-[#0F6FC6] text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <Link href={`/${locale}/contact`} className="inline-block px-10 py-4 bg-white text-[#0F6FC6] font-black rounded-lg hover:bg-white/90 transition-colors text-sm uppercase tracking-wide">
            {d.ctaButton}
          </Link>
        </div>
      </section>
